...
// this V1 doesn't have yet. pensionEmployerRate (Pension Reform Act
// minimum 10%) never touches the employee's own deductions/net pay —
// it's tracked purely so a payslip can disclose it, same as every
// conventional Nigerian payslip does.
export function computePayslip({ baseSalary, allowances, pensionEmployeeRate, pensionEmployerRate }) {
  ...
  const pensionEmployerMonthly = base * ((Number(pensionEmployerRate) || 0) / 100);
